...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Singly_Linked_List.cpp")
    list(APPEND TEST_SOURCES tests/Test_Singly_Linked_List.cpp)
endif()
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Doubly_Linked_List.cpp")
    list(APPEND TEST_SOURCES tests/Test_Doubly_Linked_List.cpp)
endif()
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Priority_Queue.cpp")
    list(APPEND TEST_SOURCES tests/Test_Priority_Queue.cpp)
endif()
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Graph_Adjacency_List.cpp")
    list(APPEND TEST_SOURCES tests/Test_Graph_Adjacency_List.cpp)
endif()
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Graph_Adjacency_Matrix.cpp")
    list(APPEND TEST_SOURCES tests/Test_Graph_Adjacency_Matrix.cpp)
endif()
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/Test_Hash_Tables.cpp")
    list(APPEND TEST_SOURCES tests/Test_Hash_Tables.cpp)
endif()
