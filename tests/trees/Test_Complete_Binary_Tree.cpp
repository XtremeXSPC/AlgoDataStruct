...
TEST_F(CompleteBinaryTreeTest, LevelOrderTraversal) {
  ...
  t.level_order_traversal([&result](int val) -> void { result.push_back(val); });
...
TEST_F(CompleteBinaryTreeTest, PreOrderTraversal) {
  ...
  std::vector<int> result;
  t.pre_order_traversal([&result](int val) -> void { result.push_back(val); });
...
TEST_F(CompleteBinaryTreeTest, InOrderTraversal) {
  ...
  std::vector<int> result;
  t.in_order_traversal([&result](int val) -> void { result.push_back(val); });
...
TEST_F(CompleteBinaryTreeTest, PostOrderTraversal) {
  ...
  std::vector<int> result;
  t.post_order_traversal([&result](int val) -> void { result.push_back(val); });
