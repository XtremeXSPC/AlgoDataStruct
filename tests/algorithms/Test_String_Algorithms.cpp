...
auto expect_indices_eq(const ads::arrays::DynamicArray<size_t>& actual, initializer_list<size_t> expected) -> void {
...
TEST(StringAlgorithmsRabinKarpTest, FindsSameMatchesAsKmp) {
  constexpr string_view text    = "bananabanaba";
  constexpr string_view pattern = "ana";
